package com.cylinder.www.utils.file;
...
public class SelfFile {
    ...
    public static String generateRemoteVideoName() {
        ...
        return "[ShareFtp]jzVideo" + dfs1.format(TimeRecord.getInstance().getStartDate()) + dfs2.format(TimeRecord.getInstance().getEndDate()) + ".mp4";
    }
    ...
    public static String generateLocalBackupVideoName() {
        ...
        return generateLocalBackupVideoDIR() + dfs1.format(TimeRecord.getInstance().getStartDate()) + dfs2.format(TimeRecord.getInstance().getEndDate()) + ".mp4";
    }
    ...
    public static String generateLocalVideoName() {
        ...
        return generateLocalVideoDIR() + Donor.getInstance().getDonorID() + dfs2.format(TimeRecord.getInstance().getStartDate()) + ".mp4";
    }
